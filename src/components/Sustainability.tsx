...
import qualityImage from "@/assets/sustainability.jpeg";

/* ✅ Certification Logos */
import bciLogo from "@/assets/certifications/bci.png";
import oekoLogo from "@/assets/certifications/oekoTex.png";
import gotsLogo from "@/assets/certifications/gots.png";
import grsLogo from "@/assets/certifications/grs.png";
  ...
  return (
    <section id="sustainability" className="section-padding bg-muted/30">
      <div className="container-custom" ref={ref}>
          ...
          >
            ...
            <div className="space-y-6">
              {certifications.map((cert, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-16 h-16 bg-white/90 rounded flex items-center justify-center p-2">
                    <img
                      src={cert.logo}
                      alt={cert.name}
        ...
        {/* Compliance Logos Carousel (UNCHANGED) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
